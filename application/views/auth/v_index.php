    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <style>
            ...
            [data-bs-theme="dark"] body {
                background-image: url('<?= base_url(); ?>assets/media/auth/bg3-dark.jpg');
            }
        </style>
            ...
            <div class="d-flex flex-lg-row-fluid">
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <div class="text-gray-600 fs-base text-center fw-semibold">
                        <img class="theme-light-show mx-auto w-300px w-lg-300px mb-10 mb-lg-20" src="<?=base_url()?>assets/images/logo.png?<?=time()?>" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="<?= base_url() ?>" action="<?= base_url('auth/login') ?>">

                                <div class="text-center mb-11">
                                    <h1 class="text-dark fw-bolder mb-3">Sign In</h1>
                                    <div class="text-gray-500 fw-semibold fs-6">To Elektronik Berkas Aneka Tunjangan</div>
                                </div>
                                <div class="separator separator-content my-14">
                                    <span class="w-125px text-gray-500 fw-semibold fs-7">E-Berangan</span>
                                </div>
                                <div class="fv-row mb-8">
                                    <input type="text" placeholder="Email" name="user_id" autocomplete="off" class="form-control bg-transparent" />
                                </div>
