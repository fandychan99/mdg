            ...
            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    <li class="breadcrumb-item text-muted">
                        <a href="#" class="text-muted text-hover-primary">VERIFIKASI TAMSIL </a>
                    </li>
...
<div class="card mb-5 mb-xl-8">
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">LIST DATA VERIFIKASI TAMSIL</span>
        </h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body col-md-10 mx-auto col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form id="kt_modal_add_user_form" class="form" action="<?= base_url(); ?>tamsil_verify/save" method="POST">
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#kt_datatable_fixed_header').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('tamsil_verify/ajax_list') ?>",
                "type": "POST",
                "data": function(d) {
