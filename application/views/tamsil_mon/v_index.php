            ...
            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    <li class="breadcrumb-item text-muted">
                        <a href="#" class="text-muted text-hover-primary">MONITORING PENGAJUAN TAMSIL </a>
                    </li>
...
<div class="card mb-5 mb-xl-8">
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">LIST TAMSIL</span>
        </h3>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#kt_datatable_fixed_header').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('tamsil_mon/ajax_list') ?>",
                "type": "POST",
                "data": function(d) {
