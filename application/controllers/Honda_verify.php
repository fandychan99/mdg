...
class Honda_verify extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model(array('M_User', 'M_Role', 'M_Sekolah', 'M_Guru', 'M_Honda_Verify'));
    ...
    public function index()
    {
        ...
        $this->template->display('honda_verify/v_index', $data);
    }

    public function ajax_list()
    {
        $list = $this->M_Honda_Verify->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_Honda_Verify->count_all(),
            "recordsFiltered" => $this->M_Honda_Verify->count_filtered(),
            "data" => $data,
        );
    ...
    function save()
    {
        try {
            ...
            $data = $this->M_Honda_Verify->save($data_simpan);
