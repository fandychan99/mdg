...
class Tpg_mon extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model(array('M_User', 'M_Role', 'M_Sekolah', 'M_Guru', 'M_Tpg_Mon'));
    ...
    public function index()
    {
        ...
        $this->template->display('tpg_mon/v_index', $data);
    }

    public function ajax_list()
    {
        $list = $this->M_Tpg_Mon->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_Tpg_Mon->count_all(),
            "recordsFiltered" => $this->M_Tpg_Mon->count_filtered(),
            "data" => $data,
        );
