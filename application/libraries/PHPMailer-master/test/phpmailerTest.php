...
EOT;
    ...
    public function testHTMLAttachment()
    {
        ...
        $this->assertFalse($this->Mail->addAttachment(__FILE__ . password_hash(microtime(), PASSWORD_DEFAULT), 'nonexistent_file.txt'));
    ...
    public function testHTMLStringEmbedNoName()
    {
        ...
        if (!$this->Mail->addStringEmbeddedImage(
            ...
            password_hash('phpmailer_mini.png', PASSWORD_DEFAULT) . '@phpmailer.0',
